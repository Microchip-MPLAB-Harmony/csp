...
void SPI3_WriteCallback(uintptr_t context )
{
    transferStatus = true;
}

/* This function will be called by SPI PLIB when transfer is completed */
void SPI3_ReadCallback(uintptr_t context )
{
    transferStatus = true;
}

/* This function will be called by SPI PLIB when transfer is completed */
void SPI3_FaultCallback(uintptr_t context )
{
...
int main ( void )
{
    ...
    SPI3_WriteCallbackRegister(SPI3_WriteCallback, 0);
    SPI3_ReadCallbackRegister(SPI3_ReadCallback, 0);
    SPI3_FaultCallbackRegister(SPI3_FaultCallback, 0);
    /* SPI Write Read */
