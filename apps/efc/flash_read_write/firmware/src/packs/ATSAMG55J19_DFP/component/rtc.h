/**
 * \brief Header file for SAMG/SAMG55 RTC
 *
...
#ifndef SAMG_SAMG55_RTC_MODULE_H
#define SAMG_SAMG55_RTC_MODULE_H

/** \addtogroup SAMG_SAMG55 Real-time Clock
 *  @{
 */
/* ========================================================================== */
/**  SOFTWARE API DEFINITION FOR SAMG55_RTC                                   */
/* ========================================================================== */
...
#define RTC_MSR_MS_Pos                        (0U)                                           /**< (RTC_MSR) Number of 1/1024 seconds elapsed within 1 second Position */
#define RTC_MSR_MS_Msk                        (0x3FFU << RTC_MSR_MS_Pos)                     /**< (RTC_MSR) Number of 1/1024 seconds elapsed within 1 second Mask */
#define RTC_MSR_MS(value)                     (RTC_MSR_MS_Msk & ((value) << RTC_MSR_MS_Pos))
#define RTC_MSR_Msk                           (0x000003FFUL)                                 /**< (RTC_MSR) Register Mask  */

/* -------- RTC_WPMR : (RTC Offset: 0xE4) (R/W 32) Write Protection Mode Register -------- */
#define RTC_WPMR_WPEN_Pos                     (0U)                                           /**< (RTC_WPMR) Write Protection Enable Position */
...
#define RTC_WPMR_WPKEY_Pos                    (8U)                                           /**< (RTC_WPMR) Write Protection Key Position */
...
#define   RTC_WPMR_WPKEY_PASSWD_Val           (5395523U)                                     /**< (RTC_WPMR) Writing any other value in this field aborts the write operation of the WPEN bit.Always reads as 0.  */
...
#define RTC_WPMR_Msk                          (0xFFFFFF01UL)                                 /**< (RTC_WPMR) Register Mask  */
...
#endif /* SAMG_SAMG55_RTC_MODULE_H */
