/**
 * \brief Header file for SAMG/SAMG55 WDT
 *
...
#ifndef SAMG_SAMG55_WDT_MODULE_H
#define SAMG_SAMG55_WDT_MODULE_H

/** \addtogroup SAMG_SAMG55 Watchdog Timer
 *  @{
 */
/* ========================================================================== */
/**  SOFTWARE API DEFINITION FOR SAMG55_WDT                                   */
/* ========================================================================== */
...
#define WDT_MR_WDRPROC_Pos                    (14U)                                          /**< (WDT_MR) Watchdog Reset Processor Position */
#define WDT_MR_WDRPROC_Msk                    (0x1U << WDT_MR_WDRPROC_Pos)                   /**< (WDT_MR) Watchdog Reset Processor Mask */
...
#define WDT_MR_Msk                            (0x3FFFFFFFUL)                                 /**< (WDT_MR) Register Mask  */

/* -------- WDT_SR : (WDT Offset: 0x08) (R/  32) Status Register -------- */
#define WDT_SR_WDUNF_Pos                      (0U)                                           /**< (WDT_SR) Watchdog Underflow Position */
#define WDT_SR_WDUNF_Msk                      (0x1U << WDT_SR_WDUNF_Pos)                     /**< (WDT_SR) Watchdog Underflow Mask */
#define WDT_SR_WDUNF(value)                   (WDT_SR_WDUNF_Msk & ((value) << WDT_SR_WDUNF_Pos))
#define WDT_SR_WDERR_Pos                      (1U)                                           /**< (WDT_SR) Watchdog Error Position */
#define WDT_SR_WDERR_Msk                      (0x1U << WDT_SR_WDERR_Pos)                     /**< (WDT_SR) Watchdog Error Mask */
...
#endif /* SAMG_SAMG55_WDT_MODULE_H */
