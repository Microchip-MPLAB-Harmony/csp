...
|FLEXCOMx\_USART\_IrDA\_DirectionSet|Sets the data transfer direction in IRDA mode|Yes|Yes|No|
...
|FLEXCOM\_IRDA\_DIR|Enum|Defines the data type for IRDA direction|Yes|Yes|No|
