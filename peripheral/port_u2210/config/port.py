...
portSym_HeaderFile.setDestPath("system/port/")
portSym_HeaderFile.setProjectPath("config/" + configName + "system/port/")
...
portSym_SourceFile.setDestPath("system/port/")
portSym_SourceFile.setProjectPath("config/" + configName + "system/port/")
