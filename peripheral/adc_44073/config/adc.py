...
def instantiateComponent(adcComponent):
    ...
    adcSym_EMR_CMPMODE.addKey("CMPMODE_LOW", "0", "Converted data is lower than low threshold")
    adcSym_EMR_CMPMODE.addKey("CMPMODE_HIGH", "1", "Converted data is higher than high threshold")
    adcSym_EMR_CMPMODE.addKey("CMPMODE_IN", "2", "Converted data is in comparison window")
    adcSym_EMR_CMPMODE.addKey("CMPMODE_OUT", "3", "Converted data is out of comparison window")
    ...
    adcSym_EMR_CMPTYPE.addKey("CMPTYPE_FLAG_ONLY", "0", "Conversion storage for all conversion")
    adcSym_EMR_CMPTYPE.addKey("CMPTYPE_START_CONDITION", "1", "Start conversion storage only after comparison match")
