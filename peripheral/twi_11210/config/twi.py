...
def setLowClockDividerValue( twiSym_CWGR_CLDIV, event):

        cldiv = getTWIClockDividerValue(event["value"])[0]
        twiSym_CWGR_CLDIV.setValue(cldiv, 1)
        
def setHighClockDividerValue( twiSym_CWGR_CHDIV, event):

        chdiv = getTWIClockDividerValue(event["value"])[1]
        twiSym_CWGR_CHDIV.setValue(chdiv, 1)

def setClockDividerValue( twiSym_CWGR_CKDIV, event):

        ckdiv = getTWIClockDividerValue(event["value"])[2]
        twiSym_CWGR_CKDIV.setValue(ckdiv, 1)
