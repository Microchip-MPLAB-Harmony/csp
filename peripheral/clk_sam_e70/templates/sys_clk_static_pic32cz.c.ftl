...
{
<#if SYS_CLK_SUPC_CR_XTALSEL_VALUE>
...
<#if SYS_CLK_CKGR_UCKR_UPLLEN>
    SYS_CLK_UPLL_SETUP upllSetup;
</#if>
<#if SYS_CLK_PMC_SCER_USBCLK>
    SYS_CLK_USB_CLOCK_SETUP usbClkSetup;
</#if>
    SYS_CLK_MASTER_SETUP masterSetup;
<#if SYS_CLK_PMC_PCR_EN0 || SYS_CLK_PMC_PCR_GCLKEN0 ||
     SYS_CLK_PMC_PCR_EN1 || SYS_CLK_PMC_PCR_GCLKEN1>
    SYS_CLK_GENERIC_SETUP gclkSetup;
</#if>
<#if SYS_CLK_PMC_SCER_PCK0 || SYS_CLK_PMC_SCER_PCK1 ||
     SYS_CLK_PMC_SCER_PCK2 || SYS_CLK_PMC_SCER_PCK3 ||
     SYS_CLK_PMC_SCER_PCK4 || SYS_CLK_PMC_SCER_PCK5 ||
     SYS_CLK_PMC_SCER_PCK6 || SYS_CLK_PMC_SCER_PCK7>
...
<#if SYS_CLK_SUPC_CR_XTALSEL_VALUE>
    ...
    slowSetup.bypassXtal = ${SYS_CLK_SUPC_MR_OSCBYPASS?c};
    SYS_CLK_SlowClockSetup ( &slowSetup );
</#if>

    /* Setup main clock source */
    mainSetup.enableXtal = ${SYS_CLK_CKGR_MOR_MOSCXTEN?c};
...
<#if SYS_CLK_CKGR_PLLAR_DIVA0_MULA0>
    ...
    pllaSetup.multiplier = ${SYS_CLK_CKGR_PLLAR_MULA};
    pllaSetup.divider = ${SYS_CLK_CKGR_PLLAR_DIVA};
...
<#if SYS_CLK_CKGR_UCKR_UPLLEN>
    ...
    upllSetup.multiplier = ${SYS_CLK_UTMI_CKTRIM_FREQ_VALUE};
    upllSetup.divider = ${SYS_CLK_PMC_MCKR_UPLLDIV2_VALUE};
...
<#if SYS_CLK_PMC_SCER_USBCLK>
    ...
    usbClkSetup.source = ${SYS_CLK_PMC_USB_USBS_VALUE};
    usbClkSetup.divider = ${SYS_CLK_PMC_USB_USBDIV};
...
<@CONFIGURE_PCR 1 SYS_CLK_PMC_PCR_EN1 SYS_CLK_PMC_PCR_GCLKEN1 SYS_CLK_PMC_PCR_GCLKCSS1_VALUE SYS_CLK_PMC_PCR_GCLKDIV1 />
<@CONFIGURE_PCK INDEX=0 ENABLED=SYS_CLK_PMC_SCER_PCK0 CSS=SYS_CLK_PMC_PCK0_CSS_VALUE PRES=SYS_CLK_PMC_PCK0_PRES />
<@CONFIGURE_PCK INDEX=1 ENABLED=SYS_CLK_PMC_SCER_PCK1 CSS=SYS_CLK_PMC_PCK1_CSS_VALUE PRES=SYS_CLK_PMC_PCK1_PRES />
<@CONFIGURE_PCK INDEX=2 ENABLED=SYS_CLK_PMC_SCER_PCK2 CSS=SYS_CLK_PMC_PCK2_CSS_VALUE PRES=SYS_CLK_PMC_PCK2_PRES />
<@CONFIGURE_PCK INDEX=3 ENABLED=SYS_CLK_PMC_SCER_PCK3 CSS=SYS_CLK_PMC_PCK3_CSS_VALUE PRES=SYS_CLK_PMC_PCK3_PRES />
<@CONFIGURE_PCK INDEX=4 ENABLED=SYS_CLK_PMC_SCER_PCK4 CSS=SYS_CLK_PMC_PCK4_CSS_VALUE PRES=SYS_CLK_PMC_PCK4_PRES />
<@CONFIGURE_PCK INDEX=5 ENABLED=SYS_CLK_PMC_SCER_PCK5 CSS=SYS_CLK_PMC_PCK5_CSS_VALUE PRES=SYS_CLK_PMC_PCK5_PRES />
<@CONFIGURE_PCK INDEX=6 ENABLED=SYS_CLK_PMC_SCER_PCK6 CSS=SYS_CLK_PMC_PCK6_CSS_VALUE PRES=SYS_CLK_PMC_PCK6_PRES />
...
uint32_t SYS_CLK_FrequencyGet ( SYS_CLK_CLOCK clock )
{
    ...
    {
        slowClk = ${SYS_CLK_CONFIG_SLOWCLK_XTAL};
    }
    else
    {
    ...
    {
      mainClk = ${SYS_CLK_CONFIG_MAINCLK_XTAL};
    }
    else
    {
...
void SYS_CLK_MainClockSetup ( const SYS_CLK_MAIN_SETUP* setup )
{
    ...
    else if ( setup->enableXtal )
    {
        ...
        _PMC_REGS->CKGR_MOR.w = CKGR_MOR_KEY_PASSWD | CKGR_MOR_MOSCXTST(${SYS_CLK_CKGR_MOSCXTST}) |
