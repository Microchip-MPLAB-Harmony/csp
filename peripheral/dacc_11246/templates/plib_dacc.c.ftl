...
void DACC${INDEX?string}_Initialize (void)
{
    ...
    _DACC_REGS->DACC_ACR.w = DACC_ACR_IBCTLCH0(${DACC_ACR_IBCTLCH0});
    <#elseif ((!DACC_CHER_CH0 && DACC_CHER_CH1) && (DACC_MR_DIFF != "DIFFERENTIAL"))>
    /* Configure DACC Bias Current */
    _DACC_REGS->DACC_ACR.w = DACC_ACR_IBCTLCH1(${DACC_ACR_IBCTLCH1});
    <#elseif ((DACC_CHER_CH0 && DACC_CHER_CH1) || (DACC_MR_DIFF == "DIFFERENTIAL"))>
    /* Configure DACC Bias Current */
	_DACC_REGS->DACC_ACR.w = DACC_ACR_IBCTLCH0(${DACC_ACR_IBCTLCH0}) | DACC_ACR_IBCTLCH1(${DACC_ACR_IBCTLCH1});
	</#if>
