...
def instantiateComponent(daccComponent):
    ...
    daccSym_MR_DIFF.setOutputMode("Name")
    ...
    for channelID in range(0, 2):
        ...
        dacChannelCoversionMode[channelID].setOutputMode("Name")
        ...
        dacChannelTriggerSelect[channelID].setOutputMode("Name")
        ...
        dacChannelOSR[channelID].setOutputMode("Name")
