...
#xosc CFD event Output control VisibleProperty
# def setXOSCCFDEOVisibleProperty(symbol, event):
    # if(event["value"] == True):
        # symbol.setVisible(True)
    # else :
        # symbol.setVisible(False)
...
oscctrlSym_Menu = coreComponent.createMenuSymbol(None, clkMenu)
...
oscctrlSymXOSCStartupNode = ATDF.getNode("/avr-tools-device-file/modules/module@[name=\"OSCCTRL\"]/value-group@[name=\"XOSC_STARTUP_TIME\"]")
...
for index in range(0, len(oscctrlSymXOSCStartupValues)):
    ...
    if (xoscstartupKeyName == "XOSC_STARTUP_1"):
...
oscctrlSymCFDPrescNode = ATDF.getNode("/avr-tools-device-file/modules/module@[name=\"OSCCTRL\"]/value-group@[name=\"XOSC_CFD_PRESCALAR\"]")
...
for index in range(0, len(oscctrlSymCFDPrescNodeValues)):
    ...
    if (xosccfdprescalarKeyName == "XOSC_FAILURE_DETECTOR_PRESCALER_1"):
...
#XOSC CFD Event Output Control
# oscctrlSym_EVCTRL_CFDEO=coreComponent.createBooleanSymbol("CONFIG_CLOCK_XOSC_CFDEO", oscctrlSym_XOSCCTRL_CFDEN)
# oscctrlSym_EVCTRL_CFDEO.setLabel("Enable Clock Failure Event Control")
# oscctrlSym_EVCTRL_CFDEO.setDescription("CFD Event o/p enabled or not")
# oscctrlSym_EVCTRL_CFDEO.setVisible(False)
# oscctrlSym_EVCTRL_CFDEO.setDefaultValue(False)
# oscctrlSym_EVCTRL_CFDEO.setDependencies(setXOSCCFDEOVisibleProperty, ["CONFIG_CLOCK_XOSC_CFDEN"])
...
oscctrlSymosc48mDivNode = ATDF.getNode("/avr-tools-device-file/modules/module@[name=\"OSCCTRL\"]/value-group@[name=\"OSC48M_DIVIDER_SELECTION\"]")
...
for index in range(0, len(oscctrlSymosc48mDivNodeValues)):
    ...
    if (osc48mdivKeyName == "OSC48M_DIV_12"):
...
oscctrlSymosc48mStartUpNode = ATDF.getNode("/avr-tools-device-file/modules/module@[name=\"OSCCTRL\"]/value-group@[name=\"OSC48M_STARTUP_TIME\"]")
...
for index in range(0, len(oscctrlSymosc48mStartUpNodeValues)):
    ...
    if (osc48mstartupKeyName == "OSC48M_STARTUP_1024"):
...
oscctrlSymDPLLLockTimeNode = ATDF.getNode("/avr-tools-device-file/modules/module@[name=\"OSCCTRL\"]/value-group@[name=\"DPLL_LOCKTIME\"]")
...
for index in range(0, len(oscctrlSymDPLLLockTimeNodeValues)):
    ...
    if (dpllLockTimeKeyName == "DPLL_LOCK_TIME_DEFAULT"):
...
oscctrlSymDPLLFilterNode = ATDF.getNode("/avr-tools-device-file/modules/module@[name=\"OSCCTRL\"]/value-group@[name=\"DPLL_FILTER_MODE\"]")
...
for index in range(0, len(oscctrlSymDPLLFilterNodeValues)):
    ...
    if (dpllfilterKeyName == "DPLL_FILTER_DEFAULT"):
...
oscctrlSymDPLLRefClkNode = ATDF.getNode("/avr-tools-device-file/modules/module@[name=\"OSCCTRL\"]/value-group@[name=\"DPLL_REFERENCE_CLOCK\"]")
...
for index in range(0, len(oscctrlSymDPLLRefClkNodeValues)):
    ...
    if (dpllrefclockKeyName == "DPLL_REFERENCE_CLOCK_XOSC32K"):
...
osc32kctrlSym_Menu = coreComponent.createMenuSymbol(None, clkMenu)
...
osc32kctrlXOSC32KStarupNode = ATDF.getNode("/avr-tools-device-file/modules/module@[name=\"OSC32KCTRL\"]/value-group@[name=\"XOSC32K_STARTUP_TIME\"]")
...
for index in range(0, len(osc32kctrlXOSC32KStarupNodeValues)):
    ...
    if (xosc32kstartupKeyName == "XOSC32K_STARTUP_1"):
...
osc32kctrlOSC32KStarupNode = ATDF.getNode("/avr-tools-device-file/modules/module@[name=\"OSC32KCTRL\"]/value-group@[name=\"OSC32K_STARTUP_TIME\"]")
...
for index in range(0, len(osc32kctrlOSC32KStarupNodeValues)):
    ...
    if (osc32kstartupKeyName == "OSC32K_STARTUP_3"):
...
for gclknumber in range(0,9):
    ...
    gclkSymGenDivSelNode = ATDF.getNode("/avr-tools-device-file/modules/module@[name=\"GCLK\"]/value-group@[name=\"GCLK_DIVISON_FACTOR_SEL\"]")
    ...
    gclkSym_GENCTRL_DIVSEL[gclknumber].setOutputMode("Value")
    ...
    gclkSym_GENCTRL_IDC[gclknumber].setDependencies(setgenctrlIDCVisibleProperty, [ "GCLK_"+str(gclknumber)+"_DIV", "GCLK_"+str(gclknumber)+"_DIVSEL"  ])
    ...
    for instance in peripheral.iter("instance"):
        for param in instance.iter("param"):
            if "GCLK_ID" in param.attrib["name"]:
                symbolId = "GCLK_ID_" + instance.attrib["name"] + param.attrib["name"].split("GCLK_ID")[1]
                ...
                clkSymPeripheral.setLabel(instance.attrib["name"] +param.attrib["name"].split("GCLK_ID")[1]+ " Clock Channel Enable")
...
def ahbInitialValueset(symbol, event):
    ahbClockValue0 = Database.getSymbolValue("core", "CONFIG_AHB_APBA_Value")
    ahbClockValue1 = Database.getSymbolValue("core", "CONFIG_AHB_APBB_Value")
    ahbClockValue2 = Database.getSymbolValue("core", "CONFIG_AHB_APBC_Value")
    ahbClockValue3 = Database.getSymbolValue("core", "CONFIG_AHB_DSU_Value")
    ahbClockValue4 = Database.getSymbolValue("core", "CONFIG_AHB_HMATRIXHS_Value")
    ahbClockValue5 = Database.getSymbolValue("core", "CONFIG_AHB_NVMCTRL_Value")
    ahbClockValue6 = Database.getSymbolValue("core", "CONFIG_AHB_HSRAM_Value")
    ahbClockValue7 = Database.getSymbolValue("core", "CONFIG_AHB_DMAC_Value")
    ahbClockValue8 = Database.getSymbolValue("core", "CONFIG_AHB_CAN0_Value")
    ahbClockValue9 = Database.getSymbolValue("core", "CONFIG_AHB_CAN1_Value")
    ahbClockValue10 = Database.getSymbolValue("core", "CONFIG_AHB_PAC_Value")
    ahbClockValue11 = Database.getSymbolValue("core", "CONFIG_AHB_DIVAS_Value")
    ahbClockValue12 = Database.getSymbolValue("core", "CONFIG_AHB_APBD_Value")
    ahbClockValue = 0x800 | ahbClockValue0 | ahbClockValue1 | ahbClockValue2 | ahbClockValue3 | ahbClockValue4 | ahbClockValue5 | ahbClockValue6 | ahbClockValue7 | ahbClockValue8 | ahbClockValue9 | ahbClockValue10 | ahbClockValue11 | ahbClockValue12
    print("ahb Clock Value is"+str(ahbClockValue))
    symbol.clearValue()
    symbol.setValue(ahbClockValue,2)

#MCLK APBA Bridge Initial Value set Property
def APBAInitialValueset(symbol, event):
    apbAClockValue0 = Database.getSymbolValue("core", "CONFIG_APBA_PAC_Value")
    apbAClockValue1 = Database.getSymbolValue("core", "CONFIG_APBA_PM_Value")
    apbAClockValue2 = Database.getSymbolValue("core", "CONFIG_APBA_MCLK_Value")
    apbAClockValue3 = Database.getSymbolValue("core", "CONFIG_APBA_RSTC_Value")
    apbAClockValue4 = Database.getSymbolValue("core", "CONFIG_APBA_OSCCTRL_Value")
    apbAClockValue5 = Database.getSymbolValue("core", "CONFIG_APBA_OSC32KCTRL_Value")
    apbAClockValue6 = Database.getSymbolValue("core", "CONFIG_APBA_SUPC_Value")
    apbAClockValue7 = Database.getSymbolValue("core", "CONFIG_APBA_GCLK_Value")
    apbAClockValue8 = Database.getSymbolValue("core", "CONFIG_APBA_WDT_Value")
    apbAClockValue9 = Database.getSymbolValue("core", "CONFIG_APBA_RTC_Value")
    apbAClockValue10 = Database.getSymbolValue("core", "CONFIG_APBA_EIC_Value")
    apbAClockValue11 = Database.getSymbolValue("core", "CONFIG_APBA_FREQM_Value")
    apbAClockValue12 = Database.getSymbolValue("core", "CONFIG_APBA_TSENS_Value")
    apbAClockValue = apbAClockValue0 | apbAClockValue1 | apbAClockValue2 | apbAClockValue3 | apbAClockValue4 | apbAClockValue5 | apbAClockValue6 | apbAClockValue7 | apbAClockValue8 | apbAClockValue9 | apbAClockValue10 | apbAClockValue11 | apbAClockValue12
    print("apbA Clock Value is"+str(apbAClockValue))
    symbol.clearValue()
    symbol.setValue(apbAClockValue,2)

#MCLK APBB Bridge Initial Value set Property
def APBBInitialValueset(symbol, event):
    apbBClockValue0 = Database.getSymbolValue("core", "CONFIG_APBB_PORT_Value")
    apbBClockValue1 = Database.getSymbolValue("core", "CONFIG_APBB_DSU_Value")
    apbBClockValue2 = Database.getSymbolValue("core", "CONFIG_APBB_NVMCTRL_Value")
    apbBClockValue5 = Database.getSymbolValue("core", "CONFIG_APBB_HMATRIXHS_Value")

    apbBClockValue = apbBClockValue0 | apbBClockValue1 | apbBClockValue2 | apbBClockValue5
    print("apbB Clock Value is"+str(apbBClockValue))
    symbol.clearValue()
    symbol.setValue(apbBClockValue,2)

#MCLK APBD Bridge Initial Value set Property
def APBDInitialValueset(symbol, event):
    apbDClockValue0 = Database.getSymbolValue("core", "CONFIG_APBD_SERCOM6_Value")
    apbDClockValue1 = Database.getSymbolValue("core", "CONFIG_APBD_SERCOM7_Value")
    apbDClockValue2 = Database.getSymbolValue("core", "CONFIG_APBD_TC5_Value")
    apbDClockValue3 = Database.getSymbolValue("core", "CONFIG_APBD_TC6_Value")
    apbDClockValue4 = Database.getSymbolValue("core", "CONFIG_APBD_TC7_Value")

    apbDClockValue = apbDClockValue0 | apbDClockValue1 | apbDClockValue2 | apbDClockValue3 | apbDClockValue4
    print("apbD Clock Value is"+str(apbDClockValue))
    symbol.clearValue()
    symbol.setValue(apbDClockValue,2)

#MCLK APBC Bridge Initial Value set Property
def APBCInitialValueset(symbol, event):
    apbCClockValue0 = Database.getSymbolValue("core", "CONFIG_APBC_EVSYS_Value")
    apbCClockValue1 = Database.getSymbolValue("core", "CONFIG_APBC_SERCOM0_Value")
    apbCClockValue2 = Database.getSymbolValue("core", "CONFIG_APBC_SERCOM1_Value")
    apbCClockValue3 = Database.getSymbolValue("core", "CONFIG_APBC_SERCOM2_Value")
    apbCClockValue4 = Database.getSymbolValue("core", "CONFIG_APBC_SERCOM3_Value")
    apbCClockValue5 = Database.getSymbolValue("core", "CONFIG_APBC_SERCOM4_Value")
    apbCClockValue6 = Database.getSymbolValue("core", "CONFIG_APBC_SERCOM5_Value")
    apbCClockValue9 = Database.getSymbolValue("core", "CONFIG_APBC_TCC0_Value")
    apbCClockValue10 = Database.getSymbolValue("core", "CONFIG_APBC_TCC1_Value")
    apbCClockValue11 = Database.getSymbolValue("core", "CONFIG_APBC_TCC2_Value")
    apbCClockValue12 = Database.getSymbolValue("core", "CONFIG_APBC_TC0_Value")
    apbCClockValue13 = Database.getSymbolValue("core", "CONFIG_APBC_TC1_Value")
    apbCClockValue14 = Database.getSymbolValue("core", "CONFIG_APBC_TC2_Value")
    apbCClockValue15 = Database.getSymbolValue("core", "CONFIG_APBC_TC3_Value")
    apbCClockValue16 = Database.getSymbolValue("core", "CONFIG_APBC_TC4_Value")
    apbCClockValue17 = Database.getSymbolValue("core", "CONFIG_APBC_ADC0_Value")
    apbCClockValue18 = Database.getSymbolValue("core", "CONFIG_APBC_ADC1_Value")
    apbCClockValue19 = Database.getSymbolValue("core", "CONFIG_APBC_SDADC_Value")
    apbCClockValue20 = Database.getSymbolValue("core", "CONFIG_APBC_AC_Value")
    apbCClockValue21 = Database.getSymbolValue("core", "CONFIG_APBC_DAC_Value")
    apbCClockValue22 = Database.getSymbolValue("core", "CONFIG_APBC_PTC_Value")
    apbCClockValue23 = Database.getSymbolValue("core", "CONFIG_APBC_CCL_Value")

    apbCClockValue = apbCClockValue0 | apbCClockValue1 | apbCClockValue2 | apbCClockValue3 | apbCClockValue4 | apbCClockValue5 | apbCClockValue6 | apbCClockValue9 | apbCClockValue10 | apbCClockValue11 | apbCClockValue12 | apbCClockValue13 | apbCClockValue14 | apbCClockValue15 | apbCClockValue16 | apbCClockValue17 | apbCClockValue18 | apbCClockValue19 | apbCClockValue20 | apbCClockValue21 | apbCClockValue22 | apbCClockValue23

    print("apbC Clock Value is"+str(apbCClockValue))
    symbol.clearValue()
...
#MCLK Main Menu
mclkSym_Menu = coreComponent.createMenuSymbol(None, clkMenu)
...
clockSym_OSCCTRL_HeaderFile.setSourcePath("../peripheral/clk_sam_c21/templates/plib_clock.h.ftl")
clockSym_OSCCTRL_HeaderFile.setOutputName("plib_clock.h")
clockSym_OSCCTRL_HeaderFile.setDestPath("system/clock/")
clockSym_OSCCTRL_HeaderFile.setProjectPath("system/clock/")
...
clockSym_OSCCTRL_SourceFile.setSourcePath("../peripheral/clk_sam_c21/templates/plib_clock.c.ftl")
clockSym_OSCCTRL_SourceFile.setOutputName("plib_clock.c")
clockSym_OSCCTRL_SourceFile.setDestPath("system/clock/")
clockSym_OSCCTRL_SourceFile.setProjectPath("system/clock/")
...
clockSystemInitFile.setSourcePath("../peripheral/clk_sam_c21/templates/system/initialization.c.ftl")
...
clockSystemDefFile.setSourcePath("../peripheral/clk_sam_c21/templates/system/definitions.h.ftl")
