...
matrixSystemInitFile.setSourcePath("../peripheral/matrix_44025/templates/system/system_initialize.c.ftl")
...
matrixSystemDefFile.setSourcePath("../peripheral/matrix_44025/templates/system/system_definitions.h.ftl")
