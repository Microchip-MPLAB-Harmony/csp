...
#pragma weak ${.vars[NVIC_VECTOR_GENERIC_HANDLER]}=Dummy_Handler
    ...
    <#else>
        ...
        <#if ([-5,-2]?seq_contains(i)) || ((i == -1) && (USE_SYSTICK_INTERRUPT == false)) || (i == -1 && (.vars[NVIC_VECTOR_ENABLE] == false)) || ((.vars[NVIC_VECTOR_NONSECURE])?? && (.vars[NVIC_VECTOR_NONSECURE] == "NON-SECURE") && (.vars[NVIC_VECTOR_ENABLE] == false))>
