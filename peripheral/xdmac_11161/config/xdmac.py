...
xdmacSystemInitFile = coreComponent.createFileSymbol(None, None)
...
xdmacSystemIntFile = coreComponent.createFileSymbol(None, None)
...
xdmacSystemDefFile = coreComponent.createFileSymbol(None, None)
