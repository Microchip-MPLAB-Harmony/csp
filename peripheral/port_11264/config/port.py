...
# bspIncludeFile.setSourcePath("../peripheral/port_11264/templates/plib_pio_bsp.h.ftl")
...
# bspIncludeFile.setSourcePath("../peripheral/port_11264/templates/plib_pio_bsp.c.ftl")
# bspIncludeFile.setMarkup(True)
