...
__STATIC_FORCEINLINE int32_t SMLATT(int32_t x,	int32_t y,	int32_t acc)
{
    register int32_t r;
...
__STATIC_FORCEINLINE  int32_t QADD( int32_t op1,  int32_t op2)
{
  int32_t result;
...
__STATIC_FORCEINLINE uint32_t QSUB8(uint32_t op1, uint32_t op2)
{
  uint32_t result;
...
__STATIC_FORCEINLINE uint32_t QSUB16(uint32_t op1, uint32_t op2)
{
  uint32_t result;
...
__STATIC_FORCEINLINE uint32_t SADD16(uint32_t op1, uint32_t op2)
{
  uint32_t result;
