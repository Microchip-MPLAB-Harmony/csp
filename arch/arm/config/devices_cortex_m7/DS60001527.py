...
deviceTCMsize.addKey("0KB", "0", "0 KB" )
deviceTCMsize.addKey("32KB", "1", "32 KB")
deviceTCMsize.addKey("64KB", "2", "64 KB")
deviceTCMsize.addKey("128KB", "3", "128 KB")
...
#devconSystemInitFile.setSourcePath("arm/templates/DS60001527.c.ftl")
