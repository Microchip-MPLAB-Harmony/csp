...
devMenu = coreComponent.createMenuSymbol("SAMD21_MENU", None)
devMenu.setLabel("Device & Project Configuration")

devCfgMenu = coreComponent.createMenuSymbol("SAMD21_CFG_MENU", devMenu)
...
prjMenu = coreComponent.createMenuSymbol("SAMD21_PROJ_MENU", devMenu)
