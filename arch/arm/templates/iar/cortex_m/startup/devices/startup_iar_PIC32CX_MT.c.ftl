...
__STATIC_INLINE void TCM_Configure(uint32_t tcmSize)
{
<#if DEVICE_ITCM_SIZE != "0" || DEVICE_DTCM_SIZE != "0">
    CMCC0_REGS->CMCC_CFG = CMCC_CFG_PRGCSIZE(tcmSize);
</#if>
}
        ...
        <#if (INSTRUCTION_CACHE_ENABLE)??>
            <#if (INSTRUCTION_CACHE_ENABLE)>
                <#if DATA_CACHE_ENABLE??>
                    <#if (DATA_CACHE_ENABLE)>
                    <#else>
                    <#lt>    CMCC0_REGS->CMCC_CTRL &= ~(CMCC_CTRL_CEN_Msk);
                    <#lt>    while((CMCC0_REGS->CMCC_SR & CMCC_SR_CSTS_Msk) == CMCC_SR_CSTS_Msk)
                    <#lt>    {
                    <#lt>        /*Wait for the operation to complete*/
                    <#lt>    }
                    <#lt>    CMCC0_REGS->CMCC_CFG |= (CMCC_CFG_DCDIS_Msk);
                    </#if>
                </#if>
                <#lt>    CMCC0_REGS->CMCC_CTRL = (CMCC_CTRL_CEN_Msk);
            </#if>
        ...
        <#if (DATA_CACHE_ENABLE)??>
            <#if (DATA_CACHE_ENABLE)>
                <#if INSTRUCTION_CACHE_ENABLE??>
                    ...
                    <#lt>        /*Wait for the operation to complete*/
                    <#lt>    }
                    <#lt>    CMCC0_REGS->CMCC_CFG |= (CMCC_CFG_ICDIS_Msk);
                    <#lt>    CMCC0_REGS->CMCC_CTRL = (CMCC_CTRL_CEN_Msk);
                    </#if>
                </#if>
            </#if>
