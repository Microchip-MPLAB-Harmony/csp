...
${LIST_SYSTEM_INTERRUPT_SECURE_WEAK_HANDLERS}

/* Multiple handlers for vector */
${LIST_SYSTEM_INTERRUPT_SECURE_MULTIPLE_HANDLERS}
...
{
    /* Configure Initial Stack Pointer, using linker-generated symbols */
    .pvStack = (uint32_t *)(&Image$$ARM_LIB_STACKHEAP$$ZI$$Limit),
<#elseif COMPILER_CHOICE == "IAR">
...
${LIST_SYSTEM_INTERRUPT_SECURE_HANDLERS}
};
