...
const LongFrequencyLabel = (props) => {
    const clockFreq = (0, harmony_plugin_client_lib_1.useLongSymbol)(props);
    ...
    return ((0, jsx_runtime_1.jsx)("div", { children: (0, jsx_runtime_1.jsx)(PlainLabel_1.default, { disPlayText: (0, Tools_1.GetClockDisplayFreqValue)(clockFreq.value), redColorStatus: (props.redColorForZeroFrequency === true && clockFreq.value === 0) ||
                props.minMaxOutofRangeRedColorStatus === true, booldStatus: props.boldLabelStatus, toolTip: props.tooltip
                ? `${formattedClockFreq} Hz ( ${props.tooltip} )`
                : `${formattedClockFreq} Hz`, className: props.className }) }));
};
exports.default = LongFrequencyLabel;
