...
export declare function AddSymboLabel(labelId: string, component_id: any, symbolId: any): JSX.Element | undefined;
...
export declare function AddInputFormatSymbolLabel(id: string, component_id: string, symbolId: string, InputFormat: (arg0: any) => void): JSX.Element | undefined;
