...
const SummaryPage = () => {
  function GetLabelAndValue(labelName: string, symbolId: string, appendString = '') {
    return (
  ...
  function SlowClockSettings() {
    return (
      <div className='flex flex-column'>
        ...
        {GetLabelAndValue('MD Slow clock Frequency', 'MD_SLOW_CLK_FREQUENCY', ' Hz')}

        {GetLabelAndValue('TD Slow clock Frequency', 'TD_SLOW_CLOCK_FREQUENCY', ' Hz')}
      </div>
    );
  }
  ...
  function PLLAControllerSettings() {
    return (
      <div className='flex flex-column'>
        ...
        {GetLabelAndValue('PLLADIV2 Clock Frequency', 'PLLADIV2CLK_FREQUENCY', ' Hz')}
      </div>
    );
  }
  ...
  function AUDIOPLLControllerSettings() {
    return (
      <div className='flex flex-column'>
        ...
        {GetLabelAndValue('AUDIO IOPLLCK Frquency', 'AUDIO_IOPLLCK_FREQUENCY', ' Hz')}
      </div>
    );
  }
      ...
      <div className='formgroup-inline'>
        ...
        <div className='field'>
          <div className='p-fluid'>
            ...
            <div className='field'>{PLLAControllerSettings()}</div>
          </div>
        </div>
        <div className='field'>
          <div className='p-fluid'>
            <div className='field'>
              <br></br>
              <span style={{ fontWeight: 'bold', fontSize: '14px' }}> UPLL Controller </span>
            </div>
            <div className='field'>{UPLLControllerSettings()}</div>
          </div>
        </div>
        <div className='field'>
          <div className='p-fluid'>
            <div className='field'>
              <br></br>
              <span style={{ fontWeight: 'bold', fontSize: '14px' }}> AUDIO PLL Controller </span>
            </div>
            <div className='field'>{AUDIOPLLControllerSettings()}</div>
          </div>
        </div>
        <div className='field'>
          <div className='p-fluid'>
            <div className='field'>
              <br></br>
              <span style={{ fontWeight: 'bold', fontSize: '14px' }}> LVDSPLL Controller </span>
            </div>
            <div className='field'>{LVDSPLLControllerSettings()}</div>
          </div>
        </div>
        <div className='field'>
          <div className='p-fluid'>
            ...
            <div className='field'>{processorClockControllerSettings()}</div>
          </div>
        </div>
        <div className='field'>
          <div className='p-fluid'>
            ...
            <div className='field'>{programmableClkControllerSettings()}</div>
          </div>
        </div>
        <div className='field'>
          <div className='p-fluid'>
            <div className='field'>
              <br></br>
              <span style={{ fontWeight: 'bold', fontSize: '14px' }}> USB clock Controller </span>
            </div>
            <div className='field'>{USBClockControllerSettings()}</div>
          </div>
        </div>
      </div>
    );
