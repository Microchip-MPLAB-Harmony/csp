  ...
  return (
    <div>
      <div className='grid'>
        <div className='col-6 text-right'>
          <div className='flex flex-column'>
            <PlainLabel disPlayText={'Desired DCO Output Frequency : '} className='' />
      ...
      <div className='grid'>
        <div className='col-6  text-right'>
          <div className='flex flex-column'>
            <PlainLabel className='' disPlayText={'Select Reference Clock Source :'} />
      ...
      <div className='grid'>
        <div className='col-6  text-right'>
          <PlainLabel className='' disPlayText={'Achievable DCO Output Freqency :'} />
        </div>
        <div className='col-6  text-right'>
