import CLOCKSAMA7D6 from "../Resources/data/react_SAML22.svg";
...
import SLCDControllerBox from "./ClockBox/SLCDControllerBox";
    ...
    <>
      ...
      >
        ...
        <Crstal32KhzOscialltorControllerBox
          ...
          />
          <SLCDControllerBox
            clockController={getBoxControlData('sdlcClkBox')}
            cx={cx}
          />
        </div>
      </div>
