import { ReactComponent as ADCBlockDiagram } from '../images/react_adc_02486.svg';
import { Button } from 'primereact/button';
import positions from './positions.module.css';
import styles from './block-diagram-view.module.css';
import { useEffect, useState, useContext } from 'react';
import { Dialog } from 'primereact/dialog';
import adc_02486_short_names from '../resources/adc_02486_short_names.json';
import {
...
function BlockDiagramView() {
  ...
  useEffect(() => {
    shortNamesApi.applyShortNames(componentId, 'ADC_MENU', adc_02486_short_names);
      ...
      <div className={cx('block-diagram-container')}>
        <div
          ...
          <div
            ...
            <ADCBlockDiagram id='adc_02486-main-image'></ADCBlockDiagram>
            <KeyValueSetRadio
